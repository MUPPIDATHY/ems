...
exports.all_report = function (req, res) {
  ...
  db.query(sql, function (err, data28) {
    ...
    db.query(sql, function (err, data27) {
      //change
      var sql = `select * from ems.certificate_details where(cand_id,all_certificate,active_flag) =('${cand_id}','Others','Y')`;
      db.query(sql,(err,data29)=>{
      var sql = `select *,DATE_FORMAT(date, '%d/%m/%Y') date from ems.certificate_details where(cand_id,all_certificate,active_flag) =('${cand_id}','Transfer Certificate','Y')`;
      ...
      var sql = `select * ,DATE_FORMAT(date, '%d/%m/%Y') date from ems.certificate_details where(cand_id,all_certificate,active_flag) =('${cand_id}','Eligiblity Certificate','Y')`;
      db.query(sql,(err,data23)=>{ 
      var sql = `select * from ems.certificate_details where(cand_id,all_certificate,active_flag) =('${cand_id}','Admission Commitee Form','Y')`;
      db.query(sql,(err,data22)=>{
      var sql = `select * from ems.certificate_details where(cand_id,all_certificate,active_flag) =('${cand_id}','Admission Certificate','Y')`;
      db.query(sql,(err,data21)=>{
                  ...
                  db.query(sql, (err, data13) => {
                    ...
                    db.query(sql, (err, data12) => {
                      ...
                      db.query(sql, (err, data11) => {
                        var sql = `SELECT * , DATE_FORMAT(relieving_date, '%d/%m/%Y') relieving_date from ems.cand_institute_details_mdms where cand_id ='${cand_id}' `;
                        db.query(sql, (err, data10) => {
                          var sql = `SELECT *,  DATE_FORMAT(relieving_date, '%d/%m/%Y') relieving_date  from ems.cand_institute_details where cand_id ='${cand_id}' `;
