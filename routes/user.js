...
exports.mbbs_board = (req, res) => {
  ...
  ems.cand_relieving_details ON ems.cand_admission_details.cand_id= ems.cand_relieving_details.cand_id where ems.cand_relieving_details.relieved= 'Yes'`;
...
exports.mdms_board = function (req, res) {
  ...
  var sql = ` SELECT * FROM ems.cand_admission_details INNER JOIN
  ems.cand_relieving_details ON ems.cand_admission_details.cand_id= ems.cand_relieving_details.cand_id where ems.cand_relieving_details.relieved= 'Yes'`;
  db.query(sql, function (err, data27) {console.table(data27)
